...
> Відкрити цю сторінку в [https://dzeshiko.github.io/modules2/](https://dzeshiko.github.io/modules2/)
...
* шукайте **https://github.com/dzeshiko/modules2** та імпортуйте

## Редагувати цей проект ![Значок статусу складання](https://github.com/dzeshiko/modules2/workflows/MakeCode/badge.svg)

Щоб відредагувати цей репозиторій у MakeCode.

* відкрийте [https://makecode.microbit.org/](https://makecode.microbit.org/)
* клацніть **Імпорт**, потім клацніть **URL-адреса імпорту**
* вставте **https://github.com/dzeshiko/modules2** і клацніть "Імпорт"
...
![Відрендерене подання блоків](https://github.com/dzeshiko/modules2/raw/master/.github/makecode/blocks.png)
